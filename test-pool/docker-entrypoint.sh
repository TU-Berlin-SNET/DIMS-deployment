...
[program:node1]
command=start_indy_node Node1 0.0.0.0 $((IDC_PORT_START+1)) 0.0.0.0 $((IDC_PORT_START+2))
directory=/home/indy
stdout_logfile=/tmp/node1.log
stderr_logfile=/tmp/node1.log

[program:node2]
command=start_indy_node Node2 0.0.0.0 $((IDC_PORT_START+3)) 0.0.0.0 $((IDC_PORT_START+4))
directory=/home/indy
stdout_logfile=/tmp/node2.log
stderr_logfile=/tmp/node2.log

[program:node3]
command=start_indy_node Node3 0.0.0.0 $((IDC_PORT_START+5)) 0.0.0.0 $((IDC_PORT_START+6))
directory=/home/indy
stdout_logfile=/tmp/node3.log
stderr_logfile=/tmp/node3.log

[program:node4]
command=start_indy_node Node4 0.0.0.0 $((IDC_PORT_START+7)) 0.0.0.0 $((IDC_PORT_START+8))
directory=/home/indy
